...
public class RepositoryTest extends WithApplication {
    ...
    public void saveBook() {
        ...
        newBook.author.id = 1 ; //UUID.fromString("bdd6741d-71b9-493c-9c31-38af19b9e27c");
        newBook.year = 1876;
        newBook.edition = 1;
        newBook.genreCollection = new HashSet<Genre>() {{
            final Genre genre = new Genre();
            genre.id = 1 ; //UUID.fromString("f022820c-cb84-4981-9184-46b6f9a17de8");
        }};
    ...
    public void saveBookFailed() {
        ...
        newBook.author = new Author();
        // Illegal author id
        newBook.author.id = 1; //UUID.fromString("bdd6741d-71b9-403c-9c31-38af19b9e27c");
        newBook.year = 1876;
        newBook.edition = 1;
        newBook.genreCollection = new HashSet<Genre>() {{
            final Genre genre = new Genre();
    ...
    public void updateAuthor() {
        ...
        author.id = 1; //UUID.fromString("bdd6741d-71b9-493c-9c31-38af19b9e27c");
